...
export default function Inputs(props) {
    ...
    const {value,eventHandler,label,placeholder,type}=props;
  return (
    <div style={{position:"relative"}} className="mainInputs">
        ...
        <input placeholder={placeholder}  value={value} onChange={eventHandler} type={type=="password"? !state?type:"text" :type}
